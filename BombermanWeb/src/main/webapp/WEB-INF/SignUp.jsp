					...
					<div class="card bg-dark text-white" style="border-radius: 1rem;">
						<div class="card-body p-5 text-center">
							...
							<div class="mb-md-5 mt-md-4 pb-5">
								...
								<p class="text-white-50 mb-5">Please enter an login and
									password</p>
								...
								<form method="post"
									...
									<div class="form-outline form-white mb-4">
										<input type="password" id="verifpassword"
											class="form-control form-control-lg" name="verifpassword"
											required /> <label class="form-label" for="verifpassword">Repeat
											your password</label>
									</div>

									<p class="small mb-5 pb-lg-2">
										By signing up you accept our <br> <a class="text-blue-50"
											href="#!" data-bs-toggle="modal" data-bs-target="#TermsModal">Terms
											Of Use</a>
									</p>
	...
	<div class="modal fade" id="TermsModal" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">Now, your soul is mine !</div>
