...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="navbar-nav ms-auto">
		<ul class="navbar-nav">
			<li class="nav-item active my-lg-0"><a class="nav-link" href="#">${ sessionScope.userSession.username }<span
					class="sr-only"></span></a></li>
			<li class="nav-item active my-lg-0"><a
				href="${ pageContext.request.contextPath }/SignOut"
				class="nav-item nav-link">Sign Out</a></li>
		</ul>
	</div>
</nav>